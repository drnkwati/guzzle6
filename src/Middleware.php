<?php
namespace GuzzleHttp\Guzzle;

use GuzzleHttp\Guzzle\Cookie\CookieJarInterface;
        ...
        return function ($handler) {
            return function ($request, array $options) use ($handler) {
                if (empty($options['cookies'])) {
                    ...
                    throw new \InvalidArgumentException('cookies must be an instance of GuzzleHttp\Guzzle\Cookie\CookieJarInterface');
                }

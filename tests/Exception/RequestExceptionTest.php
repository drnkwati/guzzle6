...
/**
 * @covers \GuzzleHttp\Guzzle\Exception\RequestException
 */
class RequestExceptionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCreatesGenerateException()
    {
        ...
        $this->assertInstanceOf('GuzzleHttp\Guzzle\Exception\RequestException', $e);
    }
    ...
    public function testCreatesClientErrorResponseException()
    {
        ...
        $this->assertInstanceOf('GuzzleHttp\Guzzle\Exception\ClientException', $e);
    }
    ...
    public function testCreatesServerErrorResponseException()
    {
        ...
        $this->assertInstanceOf('GuzzleHttp\Guzzle\Exception\ServerException', $e);
    }
    ...
    public function testWrapsRequestExceptions()
    {
        ...
        $this->assertInstanceOf('GuzzleHttp\Guzzle\Exception\RequestException', $ex);

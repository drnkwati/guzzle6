...
use GuzzleHttp\Guzzle\Handler\StreamHandler;
...
/**
 * @covers \GuzzleHttp\Guzzle\Handler\StreamHandler
 */
class StreamHandlerTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $path = $path = \GuzzleHttp\Guzzle\default_ca_bundle();
    ...
    public function testInvokesOnStatsOnError()
    {
        ...
        $this->assertInstanceOf(
            '\GuzzleHttp\Guzzle\Exception\ConnectException',

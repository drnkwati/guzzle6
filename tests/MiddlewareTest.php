...
class MiddlewareTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @expectedException \GuzzleHttp\Guzzle\Exception\ClientException
     */
    ...
    /**
     * @expectedException \GuzzleHttp\Guzzle\Exception\ServerException
     */
    ...
    public function testTracksHistoryForFailures()
    {
        ...
        $this->assertEquals('GET', $container[0]['request']->getMethod());
        $this->assertInstanceOf('\GuzzleHttp\Guzzle\Exception\RequestException', $container[0]['error']);
    }

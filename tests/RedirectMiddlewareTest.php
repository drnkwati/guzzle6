...
use GuzzleHttp\Guzzle\RedirectMiddleware;
use Psr\Http\Message\RequestInterface;

/**
 * @covers \GuzzleHttp\Guzzle\RedirectMiddleware
 */
class RedirectMiddlewareTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @expectedException \GuzzleHttp\Guzzle\Exception\TooManyRedirectsException
    ...
    /**
     * @expectedException \GuzzleHttp\Guzzle\Exception\BadResponseException
